...
namespace CCEM.Core.Sccm.Automation.policy
{
    /// <summary>
    ...
    public class actualConfig : baseInit
    {
        ...
        public class CCM_CollectionVariable : CCM_Policy
        {
            ...
            public string DecodeValue()
            {
                ...
                string sCode = AutomationScripts.SecretDecode + "\r" + "$PolicySecret = ([XML]'" + Value +"').PolicySecret.FirstChild.Value" + "\r" + "Invoke-Command $script";
