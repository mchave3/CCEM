...
namespace CCEM.Core.Sccm.Automation.functions
{
    /// <summary>
    ...
    public class health : baseInit
    {
        ...
        public string GetDCOMPerm(string HKLMKey, string RegValue)
        {
            ...
            //Cache for 30 seconds
            base.cacheTime = new TimeSpan(0, 0, 30);
            string sResult = base.GetStringFromPS(string.Format(AutomationScripts.GetDcomPermTemplate, HKLMKey, RegValue));
        ...
        {
            string sResult = base.GetStringFromPS(string.Format(AutomationScripts.SetDcomPermTemplate, HKLMKey, RegValue, ACL), true);
            return "";
        }
        ...
        public string RunHealthCheck()
        {
            try
            {
                List<PSObject> res = base.GetObjectsFromPS(AutomationScripts.HealthCheck);
