...
public partial class BreadcrumbPageMappings
{
    public static Dictionary<Type, BreadcrumbPageConfig> PageDictionary = new()
    {
        ...
        {typeof(CCEM.Views.SCCM.ConnectionPage), new BreadcrumbPageConfig { PageTitle = "Connection", IsHeaderVisible = true, ClearNavigation = false}},
        {typeof(CCEM.Views.Shared.PlaceholderPage), new BreadcrumbPageConfig { PageTitle = null, IsHeaderVisible = true, ClearNavigation = false}},
        {typeof(CCEM.Views.Intune.ComingSoonPage), new BreadcrumbPageConfig { PageTitle = "Intune", IsHeaderVisible = true, ClearNavigation = false}},
    };
}
