...
using static CCEM.SCCM.Automation.functions.agentproperties;
using System.Net;
using System.Xml;
using System.IO;
using System.Collections.Generic;

namespace CCEM.SCCM.Automation.functions
{
        ...
        public static string getPSWMIScript(string sXMLBody)
        {
            ...
            foreach (XmlNode xNode in xDoc.SelectNodes("/ReplyAssignments/EPolicy/PolicyXML"))
            {
                try
                {
                    ...
                    string sXMLPolicy = CCEM.SCCM.Automation.policy.localpolicy.DecompressPolicy(sComp);
                    sXMLPolicy.ToString();
